...
- Herbouwt dashboardlabels op basis van dezelfde WattBalans-classifier als de mirror-entiteiten.
- Geeft het dashboard originele bronnaam-metadata mee, zodat labels niet meer alleen uit de mirrornaam worden afgeleid.
- Maakt dubbele labels unieker met korte suffixen zoals `T1`, `T2`, `nu`, `straks`, `vermogen` en `energie`.
- Verbetert batterij-, kosten-, net- en energie-labels in kaarten en detailpagina's.
